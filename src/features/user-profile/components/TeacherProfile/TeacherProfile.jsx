...
export default function TeacherProfile() {
  ...
  // Profile API hook
  const { profileLoading, getMyTeacherProfile, getTeacherProfileRef } =
    useProfileApi();
    ...
    const loadProfile = async () => {
      ...
      try {
        ...
        if (
          ...
          profileData.extraJson !== null &&
          profileData.extraJson !== "null"
        ) {
          try {
            // Handle both string and already parsed JSON
            const parsed =
              typeof profileData.extraJson === "string"
                        ...
                        <div>
                          ...
                          <div className="space-y-1 text-sm text-gray-600">
                            ...
                            <p>
                              ...
                              {profile.phoneNumber || null || "Chưa cập nhật"}
                            </p>
                            <p>
                        ...
                        <div>
                          ...
                          <div className="space-y-1 text-sm text-gray-600">
                            <p>
                              ...
                              {profile.teacherCode || "Chưa cập nhật"}
                            </p>
                            <p>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {extraData.specializations &&
                          extraData.specializations.length > 0 ? (
                            extraData.specializations.map(
                              (specialization, index) => (
                                <Badge
                                  key={index}
                                  className="bg-gradient-blue text-white flex items-center gap-1"
                                >
                            ...
                            <p className="text-gray-500 italic">
                              Chưa có chuyên môn nào được cập nhật.
                            </p>
                          )}
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {extraData.teachingSubjects &&
                          extraData.teachingSubjects.length > 0 ? (
                            extraData.teachingSubjects.map((subject, index) => (
                              <Badge
                                key={index}
                                className="bg-gradient-green text-white flex items-center gap-1"
                              >
                            ...
                            <p className="text-gray-500 italic">
                              Chưa có môn học nào được cập nhật.
                            </p>
                          )}
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {extraData.researchAreas &&
                          extraData.researchAreas.length > 0 ? (
                            extraData.researchAreas.map((area, index) => (
                              <Badge
                                key={index}
                                className="bg-gradient-purple text-white flex items-center gap-1"
                              >
                            ...
                            <p className="text-gray-500 italic">
                              Chưa có lĩnh vực nghiên cứu nào được cập nhật.
                            </p>
                          )}
                        </div>
                      </div>
                ...
                <PostCard
                  ...
                  onEdit={() =>
                    handleEditPost({
                      id: 1,
                      content:
                        "Chia sẻ kinh nghiệm dạy Tin học cho học sinh THPT. Các phương pháp giảng dạy hiệu quả và cách khuyến khích học sinh tìm hiểu công nghệ 🎓 #GiáoDục #TinHọc",
                      author:
                        profile?.firstName && profile?.lastName
                          ? `${profile.firstName} ${profile.lastName}`
                          : profile?.username || "Tôi",
                ...
                <PostCard
                  ...
                  onEdit={() =>
                    handleEditPost({
                      id: 2,
                      content:
                        "Tổ chức thành công workshop 'Lập trình Scratch cho học sinh' với 45 em tham gia. Cảm ơn các em đã nhiệt tình tham gia! 🚀 #Scratch #LậpTrình",
                      images: [
                        "/Picturemockdata/DSC04766.jpg",
                        "/Picturemockdata/DSC03778.jpg",
                      ],
                ...
                <PostCard
                  ...
                  onEdit={() =>
                    handleEditPost({
                      id: 3,
                      content:
                        "Thông báo về cuộc thi 'Sáng tạo ứng dụng di động' dành cho học sinh khối 11-12. Hạn nộp bài: 15/12/2024. Giải thưởng hấp dẫn đang chờ đón! 🏆",
                    })
                  }
                  onDelete={() =>
                    handleDeletePost({
                ...
                <PostCard
                  ...
                  onEdit={() =>
                    handleEditPost({
                      id: 4,
                      content:
                        "Chia sẻ tài liệu học tập về 'An toàn thông tin trên Internet' cho học sinh. Các em hãy tải về và học tập nhé! 📚 #AnToànThôngTin #HọcTập",
                      images: [
                        "/Picturemockdata/IMG_1492.jpg",
                        "/Picturemockdata/DSC03778.jpg",
                        "/Picturemockdata/DSC04766.jpg",
                ...
                <PostCard
                  ...
                  onEdit={() =>
                    handleEditPost({
                      id: 5,
                      content:
                        "Kết quả bài kiểm tra giữa kỳ môn Tin học 12. Chúc mừng các em đạt điểm cao! Những em chưa đạt yêu cầu hãy cố gắng hơn nữa 💪 #KếtQuảThi #TinHọc12",
                      images: [
                        "/Picturemockdata/DSC03778.jpg",
                        "/Picturemockdata/IMG_1492.jpg",
                      ],
