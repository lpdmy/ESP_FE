        ...
        <div className="flex items-center justify-between max-w-7xl mx-auto">
          ...
          <div className="flex items-center space-x-4">
            ...
            <Link to={ROUTES.LANDING.HOME} className="flex items-center space-x-3 group">
              <img src="https://ibb.co/R49yJWLK" className="w-12 h-12 bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl flex items-center justify-center group-hover:shadow-md transition-all duration-300 group-hover:scale-105">
              </img>
